    ...
    <div class="top-sidebar">
        ...
        <div class="account-panel">
            ...
            <div class="account-info">
                <span id="accountName"><?php echo $userName; ?></span>
                <span id="accountRole"><?php echo $role; ?></span>
            </div>
        </div>
    </div>
    <hr style="width: 95%" />
        ...
        <div class="sidebar-options">
            ...
            <button>
                <div class="option-button">
                    ...
                    <label for="documents">Change Password <strong>(Coming Soon)</strong></label>
                </div>
            </button>
            <button onclick="window.location.href=' ../src/scripts/components/actions/logout.php'">
                <div class="option-button">
                    <span class="material-icons-round"> logout </span>
                    <label for="documents">Logout</label>
                </div>
            </button>
        </div>
    </div>
