...
<head>
    ...
    <!-- Local Styles -->
    <link rel="stylesheet" href="../src/styles/pages/sectors/agricultural-office.css" />
    ...
    <title>Agricultural Office | Doctrax</title>
            ...
            <div class="page-container">
                ...
                <div class="sub-container">
                    ...
                    <div class="sector-overview">
                        <h1>Overview</h1>
                            Provides support to local farmers , livestock owners, and
                            fisherfolk, by offering agricultural services, subsidies, training,
                ...
                <div class="image-container">
                    <img src="../assets/images/ago.jpg" alt="General Services Office" />
                </div>
                        <div class="transaction-options">
                            <div class="transaction">
                                <span>Fertilizer Subsidy Application</span>
                            </div>
                            <div class="transaction">
                                <span>Immunization Record</span>
                            </div>
                            <div class="transaction">
                                <span>Livestock Vaccination Request</span>
                            </div>
                            <div class="transaction">
                                <span>Pre-Natal Record</span>
                            </div>
                            <div class="transaction">
                                <span>Farm Equipment Loan Form</span>
                            </div>
                        </div>
                    </div>
                    <div class="frame-10">
                    ...
                    <div class="action-button">
                        <button id="autoFillForm" onclick="redirectDepartmentCode('agricultural-office')">
                            <div class="proceed">
                                <span>Proceed</span>
                            </div>
                        </button>
