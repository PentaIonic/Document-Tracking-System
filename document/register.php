        ...
        <main>
            <div class="page-container">
                <div class="form-wrapper">
                    <form class="registration-form" id="recordForm" action="../src" method="post">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group left">
                                ...
                                <div class="radio-group">
                                    <label class="label-bold"><input type="radio" name="sex" value="Male" />
                                        Male</label>
                                ...
                                <label class="label-bold">Address <span style="color: red">*</span></label><textarea
                                    name="address" id="address" rows="3" class="address-box" required></textarea>
                            </div>
