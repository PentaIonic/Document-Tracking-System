...
<head>
    ...
    <title>General Services Office | Doctrax</title>
            ...
            <div class="page-container">
                <aside class="sidebar">
                    ...
                    <ul>
                        ...
                        <li class="active"><a href="./general-services-office-directory.php">🛠️ General Services
                                Office</a></li>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Accomplished Request form, Endorsement from department head</td>
                                <td>1-3 Working Days</td>
                            </tr>
                            <tr>
                                <td>Inventory Report</td>
                                <td>Filled-out inventory report form, department head's signature</td>
                                <td>2-5 Working Days</td>
                            </tr>
                            <tr>
                                <td>Maintenance Request</td>
                                <td>Valid ID (Employee), Filled-out maintenance request form</td>
                                <td>1-3 Working Days</td>
                            </tr>
                            <tr>
                                <td>Equipment Borrowing Form</td>
                                <td>Valid ID, Borrowing form, Approval from property custodian or department head</td>
